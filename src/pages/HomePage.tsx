...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-end justify-between mb-8">
            ...
            <button
              ...
              className="text-xs sm:text-sm font-bold text-pink-500 hover:text-pink-600 flex items-center gap-1 group cursor-pointer"
            >
      ...
      <section className="py-10 sm:py-14 bg-rose-50/30 dark:bg-slate-900/30 border-y border-pink-100/60 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

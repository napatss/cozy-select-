        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 rounded-xl border border-primary-container/40 dark:border-slate-800 hover:bg-primary-container/20 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className={`p-6 sm:p-7 rounded-3xl border space-y-5 ${
              ...
              <div className="flex items-center gap-2.5 text-base sm:text-lg font-serif-luxury font-bold text-slate-900 dark:text-white">
                <span className="w-7 h-7 rounded-full bg-electric-pink text-white text-xs flex items-center justify-center font-sans font-black">
                  1
                </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-baby-pink dark:border-slate-700 bg-primary-container/15/20 dark:bg-slate-800 outline-hidden focus:border-electric-pink"
                  />
                </div>
            ...
            <div className={`p-6 sm:p-7 rounded-3xl border space-y-5 ${
              ...
              <div className="flex items-center justify-between">
                ...
                {isFreeShipping && (
                  <span className="bg-primary-container/40 dark:bg-pink-950 text-tertiary dark:text-baby-pink text-xs font-bold px-2.5 py-1 rounded-full flex items-center gap-1">
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-2xl border-2 transition-all cursor-pointer flex items-center justify-between ${
                        isSelected
                          ? 'border-electric-pink bg-primary-container/20/60 dark:bg-pink-950/40 shadow-xs'
                          : 'border-slate-200 dark:border-slate-800 hover:border-baby-pink'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                          isSelected ? 'bg-electric-pink text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300'
                        }`}>
                      ...
                      <div className="text-right">
                        <span className={`text-xs font-bold ${isFreeShipping ? 'text-electric-pink' : 'text-slate-900 dark:text-white'}`}>
            ...
            <div className={`p-6 sm:p-7 rounded-3xl border space-y-5 ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border-2 text-left transition-all cursor-pointer flex flex-col justify-between gap-2 ${
                    selectedPaymentMethod === 'promptpay_qr'
                      ? 'border-electric-pink bg-primary-container/20/60 dark:bg-pink-950/40'
                      : 'border-slate-200 dark:border-slate-800 hover:border-baby-pink'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <QrCode className="w-5 h-5 text-electric-pink" />
                    {selectedPaymentMethod === 'promptpay_qr' && <CheckCircle2 className="w-4 h-4 text-electric-pink" />}
                  </div>
                  <div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <CreditCard className="w-5 h-5 text-electric-pink" />
                    {selectedPaymentMethod === 'credit_card' && <CheckCircle2 className="w-4 h-4 text-electric-pink" />}
                  </div>
                  <div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <DollarSign className="w-5 h-5 text-electric-pink" />
                    {selectedPaymentMethod === 'cod' && <CheckCircle2 className="w-4 h-4 text-electric-pink" />}
                  </div>
                  <div>
              ...
              <div className="mt-4 p-5 rounded-2xl bg-primary-container/15/40 dark:bg-slate-800/60 border border-primary-container/40 dark:border-slate-700">
                ...
                {selectedPaymentMethod === 'promptpay_qr' && (
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    <div className="p-4 bg-white rounded-2xl shadow-md border text-center flex flex-col items-center shrink-0">
                      ...
                      <div className="text-[10px] text-tertiary font-extrabold">
                        ฿{finalTotal.toLocaleString()}
                      </div>
                    </div>

                    <div className="space-y-3 flex-1">
                      <div className="flex items-center gap-2 text-xs font-bold text-tertiary bg-primary-container/40/60 dark:bg-pink-950 px-3 py-1.5 rounded-xl w-fit">
                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex items-center gap-3">
                          <label className="px-4 py-2 rounded-xl bg-electric-pink hover:bg-tertiary text-white text-xs font-bold cursor-pointer flex items-center gap-1.5 transition-colors shadow-xs">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-xs text-tertiary hover:text-pink-700 font-bold underline cursor-pointer"
                      >
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-xs rounded-xl border border-baby-pink dark:border-slate-700 bg-white dark:bg-slate-900 outline-hidden font-mono"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-xs uppercase rounded-xl border border-baby-pink dark:border-slate-700 bg-white dark:bg-slate-900 outline-hidden font-mono"
                        />
                      </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className={`p-6 rounded-3xl border sticky top-24 space-y-5 ${
              theme === 'dark' ? 'bg-slate-900 border-slate-800 text-white' : 'bg-white border-primary-container/40 shadow-xl shadow-primary-container/40/50 text-slate-800'
            }`}>
              ...
              {/* Items Mini List */}
              <div className="max-h-48 overflow-y-auto space-y-3 divide-y divide-primary-container/40 dark:divide-slate-800 pr-1">
                {cart.map((it) => (
                  <div key={it.id} className="pt-2 flex items-center gap-3">
                    <img
                      src={it.product.images[0]}
                      alt="item"
                      className="w-12 h-14 rounded-xl object-cover bg-primary-container/15 shrink-0"
                    />
              ...
              {/* Price Details */}
              <div className="space-y-2 text-xs sm:text-sm border-t border-primary-container/40 dark:border-slate-800 pt-4">
                ...
                <div className="flex justify-between items-baseline pt-2 border-t border-primary-container/40 dark:border-slate-800">
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-electric-pink to-tertiary hover:from-tertiary hover:to-tertiary disabled:opacity-50 text-white font-bold text-sm tracking-wider shadow-lg shadow-electric-pink/35 hover:scale-[1.01] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >

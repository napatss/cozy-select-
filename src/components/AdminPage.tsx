    ...
    return (
      <div className="py-16 sm:py-24 bg-[#FFF5F8] dark:bg-[#1a0f18] min-h-[80vh] flex items-center justify-center">
        <div className="max-w-md w-full mx-auto px-4">
          <div className="p-8 rounded-3xl border border-primary-container/40 dark:border-pink-900/40 bg-white dark:bg-[#251522] shadow-2xl shadow-baby-pink/50 dark:shadow-none text-center space-y-6">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-electric-pink to-baby-pink text-white flex items-center justify-center mx-auto shadow-lg shadow-baby-pink">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div className="text-left">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-2xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/30 dark:bg-pink-950/20 text-sm outline-hidden focus:border-electric-pink font-mono transition-colors"
                />
              </div>

              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl bg-[#E83A80] hover:bg-tertiary text-white font-bold text-sm shadow-md shadow-baby-pink hover:shadow-lg transition-all cursor-pointer"
              >
                เข้าสู่ระบบ
              </button>
              ...
              <div className="pt-2">
                <p className="text-[11px] text-slate-400">
                  บัญชีเริ่มต้น (ทดสอบ): <span className="font-mono text-tertiary font-bold">admin</span> / <span className="font-mono text-tertiary font-bold">admin1234</span>
                </p>
              </div>
            </form>
          </div>
  ...
  return (
    <div className="py-6 sm:py-10 bg-[#FFF5F8] dark:bg-[#1a0f18] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {/* Top Header Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#251522] p-5 rounded-3xl border border-primary-container/40 dark:border-pink-900/30 shadow-xs">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#E83A80] text-white flex items-center justify-center font-bold shadow-md shadow-baby-pink">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                adminTab === 'products'
                  ? 'bg-[#E83A80] text-white shadow-md shadow-baby-pink'
                  : 'bg-primary-container/20 dark:bg-pink-950/40 text-pink-700 dark:text-baby-pink hover:bg-primary-container/40'
              }`}
            >
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-slate-100 hover:bg-primary-container/40 text-slate-700 dark:bg-slate-800 dark:text-slate-300 text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              onClick={adminLogout}
              className="px-3 py-2 rounded-xl bg-primary-container/15 hover:bg-primary-container/30 text-tertiary text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
            >
        ...
        {adminTab === 'products' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div ref={formRef} className="lg:col-span-5 bg-white dark:bg-[#251522] p-6 rounded-3xl border border-primary-container/40 dark:border-pink-900/30 shadow-xs space-y-5">
              <div className="flex items-center justify-between border-b border-primary-container/40 dark:border-pink-900/40 pb-3">
                <div className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-xl flex items-center justify-center ${editingProductId ? 'bg-amber-100 text-amber-600' : 'bg-primary-container/40 text-tertiary'}`}>
              ...
              <form onSubmit={handleSaveProduct} className="space-y-4 text-xs">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 dark:bg-pink-950/20 text-sm outline-hidden focus:border-electric-pink"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 dark:bg-pink-950/20 text-sm font-bold text-tertiary outline-hidden focus:border-electric-pink"
                    />
                  </div>
                  <div>
                    <label className="font-bold text-slate-700 dark:text-slate-300 block mb-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 dark:bg-pink-950/20 text-xs font-semibold outline-hidden focus:border-electric-pink"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 dark:bg-pink-950/20 text-sm font-bold outline-hidden focus:border-electric-pink"
                    />
                  </div>
                </div>

                {/* Image Upload & Management */}
                <div className="space-y-2 pt-1 border-t border-primary-container/40 dark:border-pink-900/40">
                  <label className="font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                    <span>รูปภาพสินค้า (Image Upload / URL)</span>
                    <span className="text-[10px] text-electric-pink font-normal">ใส่ได้ทั้งไฟล์รูปและ URL</span>
                  </label>

                  {/* Upload Box */}
                  <div className="border-2 border-dashed border-baby-pink dark:border-pink-900/60 rounded-2xl p-4 text-center bg-primary-container/20/20 dark:bg-pink-950/20 hover:bg-primary-container/20/50 transition-colors">
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    >
                      <div className="w-10 h-10 rounded-full bg-primary-container/40 text-[#E83A80] flex items-center justify-center">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 text-xs outline-hidden"
                    />
                    <button
                      type="button"
                      onClick={handleAddImageUrl}
                      className="px-3 py-2 rounded-xl bg-primary-container/40 hover:bg-baby-pink text-pink-700 font-bold text-xs cursor-pointer"
                    >
                      เพิ่ม URL
                    </button>
                  </div>
                    ...
                    <div className="pt-2">
                      ...
                      <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                        {productForm.images.map((imgUrl, idx) => (
                          <div key={idx} className="relative group rounded-xl overflow-hidden border border-baby-pink dark:border-pink-900 aspect-square bg-slate-100">
                            <img src={imgUrl} alt={`preview-${idx}`} className="w-full h-full object-cover" />
                            <button
                              type="button"
                              onClick={() => handleRemoveImage(idx)}
                              className="absolute top-1 right-1 w-5 h-5 rounded-full bg-black/70 text-white flex items-center justify-center text-[10px] hover:bg-tertiary transition-colors cursor-pointer"
                              title="ลบรูปนี้"
                            >
                              ✕
                            </button>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 text-xs outline-hidden focus:border-electric-pink"
                  />
                </div>
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 rounded-2xl text-white font-bold text-xs shadow-md transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                      editingProductId
                        ...
                        : 'bg-[#E83A80] hover:bg-tertiary shadow-baby-pink'
                    }`}
                  >
                    {editingProductId ? (
                      <>
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="bg-white dark:bg-[#251522] p-5 rounded-3xl border border-primary-container/40 dark:border-pink-900/30 shadow-xs space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                  <div>
                    <h2 className="font-mitr font-bold text-base text-slate-900 dark:text-white flex items-center gap-2">
                      ...
                      <span className="text-xs px-2.5 py-0.5 rounded-full bg-primary-container/40 text-pink-700 font-bold">
                  ...
                  <div className="relative w-full sm:w-64">
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 text-xs rounded-xl border border-baby-pink dark:border-pink-900/60 bg-primary-container/20/20 text-slate-800 dark:text-slate-200 outline-hidden focus:border-electric-pink"
                    />
                    <Search className="w-3.5 h-3.5 text-electric-pink absolute left-3 top-2.5" />
                  </div>
                </div>

                {/* Table */}
                <div className="overflow-x-auto rounded-2xl border border-primary-container/40 dark:border-pink-900/30">
                  <table className="w-full text-left text-xs">
                    <thead className="bg-[#FFF5F8] dark:bg-pink-950/40 text-slate-600 dark:text-slate-300 font-bold border-b border-primary-container/40 dark:border-pink-900/40">
                      <tr>
                    ...
                    <tbody className="divide-y divide-primary-container/40/60 dark:divide-pink-900/30">
                          ...
                          <tr 
                            ...
                            className={`transition-colors ${
                              isBeingEdited 
                                ...
                                : 'hover:bg-primary-container/20/30 dark:hover:bg-pink-950/20'
                            }`}
                          >
                            {/* Product Info & Thumb */}
                            <td className="py-3 px-3">
                              <div className="flex items-center gap-2.5">
                                <img 
                                  ...
                                  alt={p.titleTh} 
                                  className="w-11 h-13 rounded-xl object-cover bg-primary-container/15 border border-primary-container/40 dark:border-pink-900 shrink-0" 
                                />
                            ...
                            <td className="py-3 px-3 capitalize font-semibold text-slate-600 dark:text-slate-300">
                              <span className="px-2 py-0.5 rounded-lg bg-primary-container/20 dark:bg-pink-950/50 text-pink-700 dark:text-baby-pink text-[11px]">
                            ...
                            <td className="py-3 px-3 text-center">
                              <div className="inline-flex items-center gap-1 bg-primary-container/20/50 dark:bg-pink-950/30 p-1 rounded-xl border border-primary-container/40 dark:border-pink-900/40">
                                <button
                                  type="button"
                                  onClick={() => handleUpdateStock(p.id, p.stock - 1)}
                                  className="w-5 h-5 rounded-lg bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold hover:bg-baby-pink flex items-center justify-center text-xs shadow-xs"
                                >
                                  -
                                </button>
                                <span className={`w-7 text-center font-bold text-xs ${isSoldOut ? 'text-tertiary' : 'text-slate-800 dark:text-slate-200'}`}>
                                  {p.stock}
                                </span>
                                <button
                                  type="button"
                            ...
                            <td className="py-3 px-3 text-right">
                              <div className="flex items-center justify-end gap-1.5">
                                <button
                                  ...
                                  className="px-2.5 py-1 rounded-xl bg-primary-container/40 hover:bg-baby-pink text-pink-700 font-bold text-[11px] transition-colors flex items-center gap-1 cursor-pointer"
                                ...
                                <button
                                  ...
                                  className="px-2.5 py-1 rounded-xl bg-primary-container/15 hover:bg-primary-container/30 text-tertiary font-bold text-[11px] transition-colors flex items-center gap-1 cursor-pointer"
                                  title="ลบสินค้านี้"
                                >
        ...
        {adminTab === 'orders' && (
          <div className="bg-white dark:bg-[#251522] p-6 rounded-3xl border border-primary-container/40 dark:border-pink-900/30 shadow-xs space-y-6">
            
            {/* Header and Filter Buttons */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-primary-container/40 dark:border-pink-900/40 pb-4">
              <div>
                ...
                {(['all', 'pending', 'processing', 'shipped', 'delivered'] as const).map((st) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                      orderFilter === st
                        ? 'bg-[#E83A80] text-white shadow-md shadow-baby-pink'
                        : 'bg-primary-container/20 dark:bg-pink-950/40 text-slate-600 dark:text-slate-300 hover:bg-primary-container/40'
                    }`}
                  >
                    {st === 'all' && 'ทั้งหมด'}
            ...
            <div className="space-y-4">
              {filteredOrders.map((o) => {
                ...
                return (
                  <div key={o.id} className="p-5 rounded-2xl border border-primary-container/40 dark:border-pink-900/40 bg-primary-container/20/20 dark:bg-pink-950/10 space-y-4 hover:border-baby-pink transition-colors">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-primary-container/40/60 dark:border-pink-900/30 pb-3">
                      <div>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <select
                          ...
                          className="px-3 py-1.5 rounded-xl text-xs font-bold border border-baby-pink dark:border-pink-900 bg-white dark:bg-slate-800 text-slate-800 dark:text-white"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-[#E83A80] hover:bg-tertiary text-white text-xs font-bold shadow-xs cursor-pointer"
                        >
                          อัปเดต
                        </button>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div className="flex items-center gap-2 flex-wrap text-xs text-slate-600 dark:text-slate-300">
                        {o.items.map((item, i) => (
                          <span key={i} className="px-2.5 py-1 rounded-lg bg-white dark:bg-slate-800 border border-primary-container/40 dark:border-pink-900 text-[11px]">
        ...
        {adminTab === 'dashboard' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-5 rounded-3xl border border-primary-container/40 dark:border-pink-900/40 bg-white dark:bg-[#251522] shadow-xs space-y-2">
              ...
              <div className="p-5 rounded-3xl border border-primary-container/40 dark:border-pink-900/40 bg-white dark:bg-[#251522] shadow-xs space-y-2">
                ...
                <p className="text-2xl font-black text-tertiary">{outOfStockCount} รายการ</p>
                <p className="text-[11px] text-tertiary font-semibold">แสดงสถานะหมดที่หน้าร้าน</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-8 p-6 rounded-3xl border border-primary-container/40 dark:border-pink-900/40 bg-white dark:bg-[#251522] space-y-4">
              ...
              <div className="lg:col-span-4 p-6 rounded-3xl border border-primary-container/40 dark:border-pink-900/40 bg-white dark:bg-[#251522] space-y-4">
                <h3 className="font-bold text-sm text-slate-900 dark:text-white flex items-center gap-2">
